...
$catalogueEn_US = new MessageCatalogue('en_US', array (
  ...
  array (
    ...
    'mautic.core.config.cors.restrict.domains.tooltip' => 'Determines which websites can communicate with Mautic through a web browser. This is specifically for when your website needs to send data to Mautic from visitors\' browsers.',
    'mautic.core.config.cors.restrict.domains.help' => 'Enhance security by controlling which external services can interact with your Mautic instance.',
    ...
    'mautic.core.config.form.cors_valid_domains.help' => 'Include all your websites using Mautic\'s tracking script, both with www and without it (e.g., https://example.com and https://www.example.com).',
    ...
    'mautic.core.form.no_change' => 'No change',
