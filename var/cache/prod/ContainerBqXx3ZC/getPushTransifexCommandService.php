...
class getPushTransifexCommandService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\CoreBundle\\Command\\PushTransifexCommand'] = new \Mautic\CoreBundle\Command\PushTransifexCommand(($container->services['Mautic\\CoreBundle\\Factory\\TransifexFactory'] ?? $container->load('getTransifexFactoryService')), ($container->services['translator'] ?? self::getTranslator2Service($container)), ($container->services['Mautic\\CoreBundle\\Helper\\LanguageHelper'] ?? $container->load('getLanguageHelperService')));
    }
}
