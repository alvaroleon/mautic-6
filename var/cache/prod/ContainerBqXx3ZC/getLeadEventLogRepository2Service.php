...
class getLeadEventLogRepository2Service extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\LeadBundle\\Entity\\LeadEventLogRepository'] = new \Mautic\LeadBundle\Entity\LeadEventLogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
