...
class getStageType2Service extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\StageBundle\\Form\\Type\\StageType'] = new \Mautic\StageBundle\Form\Type\StageType(($container->services['mautic.security'] ?? self::getMautic_SecurityService($container)));
    }
}
