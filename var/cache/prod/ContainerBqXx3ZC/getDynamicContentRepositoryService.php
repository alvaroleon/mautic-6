...
class getDynamicContentRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\DynamicContentBundle\\Entity\\DynamicContentRepository'] = new \Mautic\DynamicContentBundle\Entity\DynamicContentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
