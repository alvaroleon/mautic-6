...
class getLeadSubscriber6Service extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Mautic\\ChannelBundle\\EventListener\\LeadSubscriber'] = new \Mautic\ChannelBundle\EventListener\LeadSubscriber(($container->services['translator'] ?? self::getTranslator2Service($container)), $a, ($container->services['Mautic\\ChannelBundle\\Entity\\MessageQueueRepository'] ?? $container->load('getMessageQueueRepositoryService')));
    }
}
