...
class getContactChannelsTypeService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\LeadBundle\\Form\\Type\\ContactChannelsType'] = new \Mautic\LeadBundle\Form\Type\ContactChannelsType(($container->services['mautic.helper.core_parameters'] ??= new \Mautic\CoreBundle\Helper\CoreParametersHelper($container)));
    }
}
