...
class getAuditLogRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\CoreBundle\\Entity\\AuditLogRepository'] = new \Mautic\CoreBundle\Entity\AuditLogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
