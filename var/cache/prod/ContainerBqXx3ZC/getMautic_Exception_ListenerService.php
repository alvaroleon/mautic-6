...
class getMautic_Exception_ListenerService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['mautic.exception.listener'] = new \Mautic\CoreBundle\EventListener\ExceptionListener($a, 'Mautic\\CoreBundle\\Controller\\ExceptionController::showAction', ($container->services['monolog.logger.mautic'] ?? self::getMonolog_Logger_MauticService($container)));
    }
}
