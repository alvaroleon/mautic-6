...
class getMautic_Integrations_Sync_Notification_WriterService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['mautic.integrations.sync.notification.writer'] = new \Mautic\IntegrationsBundle\Sync\Notification\Writer(($container->services['Mautic\\CoreBundle\\Model\\NotificationModel'] ?? self::getNotificationModelService($container)), ($container->services['Mautic\\CoreBundle\\Model\\AuditLogModel'] ?? self::getAuditLogModelService($container)), ($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)));
    }
}
