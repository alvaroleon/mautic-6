...
class getMaxmindPrecisionLookupService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\CoreBundle\\IpLookup\\MaxmindPrecisionLookup'] = new \Mautic\CoreBundle\IpLookup\MaxmindPrecisionLookup(NULL, NULL, NULL, ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), ($container->services['mautic.http.client'] ??= new \GuzzleHttp\Client()), ($container->services['mautic.helper.core_parameters'] ??= new \Mautic\CoreBundle\Helper\CoreParametersHelper($container)));
    }
}
