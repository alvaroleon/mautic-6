...
class getMautic_Form_List_Validator_CircularService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['mautic.form.list.validator.circular'] = new \Mautic\CoreBundle\Form\Validator\Constraints\CircularDependencyValidator($a, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
    }
}
