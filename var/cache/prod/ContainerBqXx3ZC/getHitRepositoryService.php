...
class getHitRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\PageBundle\\Entity\\HitRepository'] = new \Mautic\PageBundle\Entity\HitRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
