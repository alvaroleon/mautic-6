...
class getUploadSubscriberService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Mautic\\AssetBundle\\EventListener\\UploadSubscriber'] = new \Mautic\AssetBundle\EventListener\UploadSubscriber(($container->services['mautic.helper.core_parameters'] ??= new \Mautic\CoreBundle\Helper\CoreParametersHelper($container)), $a, ($container->services['Mautic\\CoreBundle\\Translation\\Translator'] ?? self::getTranslatorService($container)), ($container->services['mautic.core.validator.file_upload'] ?? self::getMautic_Core_Validator_FileUploadService($container)));
    }
}
