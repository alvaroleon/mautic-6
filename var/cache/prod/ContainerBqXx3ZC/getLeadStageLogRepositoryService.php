...
class getLeadStageLogRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\StageBundle\\Entity\\LeadStageLogRepository'] = new \Mautic\StageBundle\Entity\LeadStageLogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
