...
class getIP2LocationBinLookupService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\CoreBundle\\IpLookup\\IP2LocationBinLookup'] = new \Mautic\CoreBundle\IpLookup\IP2LocationBinLookup(NULL, NULL, NULL, ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), ($container->services['mautic.http.client'] ??= new \GuzzleHttp\Client()), ($container->services['mautic.helper.core_parameters'] ??= new \Mautic\CoreBundle\Helper\CoreParametersHelper($container)));
    }
}
