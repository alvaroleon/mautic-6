...
class getDoNotContactSubscriberService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\LeadBundle\\EventListener\\DoNotContactSubscriber'] = new \Mautic\LeadBundle\EventListener\DoNotContactSubscriber(($container->services['Mautic\\LeadBundle\\Model\\DoNotContact'] ?? self::getDoNotContactService($container)));
    }
}
