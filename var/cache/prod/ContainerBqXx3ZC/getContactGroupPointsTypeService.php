...
class getContactGroupPointsTypeService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\LeadBundle\\Form\\Type\\ContactGroupPointsType'] = new \Mautic\LeadBundle\Form\Type\ContactGroupPointsType(($container->services['translator'] ?? self::getTranslator2Service($container)));
    }
}
