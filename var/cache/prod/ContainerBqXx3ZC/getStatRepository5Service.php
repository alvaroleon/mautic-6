...
class getStatRepository5Service extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\SmsBundle\\Entity\\StatRepository'] = new \Mautic\SmsBundle\Entity\StatRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
