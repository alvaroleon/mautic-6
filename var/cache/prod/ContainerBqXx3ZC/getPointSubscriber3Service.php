...
class getPointSubscriber3Service extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->services['Mautic\\EmailBundle\\Helper\\PointEventHelper'] ?? $container->load('getPointEventHelperService'));

        if (isset($container->services['Mautic\\EmailBundle\\EventListener\\PointSubscriber'])) {
            return $container->services['Mautic\\EmailBundle\\EventListener\\PointSubscriber'];
        }

        return $container->services['Mautic\\EmailBundle\\EventListener\\PointSubscriber'] = new \Mautic\EmailBundle\EventListener\PointSubscriber($a, ($container->services['mautic.permission.manager'] ?? self::getMautic_Permission_ManagerService($container)), $b);
    }
}
