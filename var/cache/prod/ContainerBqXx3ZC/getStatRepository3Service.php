...
class getStatRepository3Service extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\DynamicContentBundle\\Entity\\StatRepository'] = new \Mautic\DynamicContentBundle\Entity\StatRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
