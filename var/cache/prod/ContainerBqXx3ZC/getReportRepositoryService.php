...
class getReportRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\ReportBundle\\Entity\\ReportRepository'] = new \Mautic\ReportBundle\Entity\ReportRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
