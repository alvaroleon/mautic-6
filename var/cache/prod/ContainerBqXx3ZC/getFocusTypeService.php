...
class getFocusTypeService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['MauticPlugin\\MauticFocusBundle\\Form\\Type\\FocusType'] = new \MauticPlugin\MauticFocusBundle\Form\Type\FocusType(($container->services['mautic.security'] ?? self::getMautic_SecurityService($container)));
    }
}
