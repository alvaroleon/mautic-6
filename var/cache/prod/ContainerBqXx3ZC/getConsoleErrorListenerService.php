...
class getConsoleErrorListenerService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\CoreBundle\\EventListener\\ConsoleErrorListener'] = new \Mautic\CoreBundle\EventListener\ConsoleErrorListener(($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)));
    }
}
