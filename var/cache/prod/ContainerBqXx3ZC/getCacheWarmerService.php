...
class getCacheWarmerService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 10 => ($container->services['mautic.cache.warmer.middleware'] ??= new \Mautic\CoreBundle\Cache\MiddlewareCacheWarmer('prod'));
        }, 11), false, ($container->targetDir.''.'/AppKernelProdContainerDeprecations.log'));
    }
}
