...
class getLeadRepository3Service extends AppKernelProdContainer
{
    ...
    {
        return $container->services['MauticPlugin\\MauticSocialBundle\\Entity\\LeadRepository'] = new \MauticPlugin\MauticSocialBundle\Entity\LeadRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
