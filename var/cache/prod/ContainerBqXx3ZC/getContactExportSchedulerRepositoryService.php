...
class getContactExportSchedulerRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\LeadBundle\\Entity\\ContactExportSchedulerRepository'] = new \Mautic\LeadBundle\Entity\ContactExportSchedulerRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
