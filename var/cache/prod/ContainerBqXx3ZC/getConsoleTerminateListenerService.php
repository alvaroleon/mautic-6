...
class getConsoleTerminateListenerService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\CoreBundle\\EventListener\\ConsoleTerminateListener'] = new \Mautic\CoreBundle\EventListener\ConsoleTerminateListener(($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)));
    }
}
