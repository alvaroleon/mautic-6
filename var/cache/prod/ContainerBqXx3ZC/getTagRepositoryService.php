...
class getTagRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['MauticPlugin\\MauticTagManagerBundle\\Entity\\TagRepository'] = new \MauticPlugin\MauticTagManagerBundle\Entity\TagRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
