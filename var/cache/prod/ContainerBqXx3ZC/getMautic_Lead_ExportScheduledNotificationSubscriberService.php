...
class getMautic_Lead_ExportScheduledNotificationSubscriberService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['mautic.lead.export_scheduled_notification_subscriber'] = new \Mautic\LeadBundle\EventListener\ContactExportSchedulerNotificationSubscriber($a, ($container->services['translator'] ?? self::getTranslator2Service($container)));
    }
}
