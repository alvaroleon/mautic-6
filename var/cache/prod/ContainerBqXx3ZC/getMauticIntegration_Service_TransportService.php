...
class getMauticIntegration_Service_TransportService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['mautic_integration.service.transport'] = new \MauticPlugin\MauticCrmBundle\Services\Transport(($container->services['mautic.http.client'] ??= new \GuzzleHttp\Client()));
    }
}
