...
class getMautic_Update_Step_UpdateSchemaService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['mautic.update.step.update_schema'] = new \Mautic\CoreBundle\Update\Step\UpdateSchemaStep(($container->services['translator'] ?? self::getTranslator2Service($container)), $container);
    }
}
