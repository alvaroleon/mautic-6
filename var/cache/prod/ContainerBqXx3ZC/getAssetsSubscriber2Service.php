...
class getAssetsSubscriber2Service extends AppKernelProdContainer
{
    ...
    {
        $a = ($container->services['mautic.install.service'] ?? self::getMautic_Install_ServiceService($container));
        ...
        return $container->services['MauticPlugin\\GrapesJsBuilderBundle\\EventSubscriber\\AssetsSubscriber'] = new \MauticPlugin\GrapesJsBuilderBundle\EventSubscriber\AssetsSubscriber(($container->services['grapesjsbuilder.config'] ?? $container->load('getGrapesjsbuilder_ConfigService')), $a, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
    }
}
