...
class getLeadPointLogRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\PointBundle\\Entity\\LeadPointLogRepository'] = new \Mautic\PointBundle\Entity\LeadPointLogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
