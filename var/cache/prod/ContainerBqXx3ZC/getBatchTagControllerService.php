...
class getBatchTagControllerService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.O2p6Lk7'] ?? self::get_ServiceLocator_O2p6Lk7Service($container))->withContext('MauticPlugin\\MauticTagManagerBundle\\Controller\\BatchTagController', $container));
