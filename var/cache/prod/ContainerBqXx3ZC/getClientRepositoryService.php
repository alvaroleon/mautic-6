...
class getClientRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\ApiBundle\\Entity\\oAuth2\\ClientRepository'] = new \Mautic\ApiBundle\Entity\oAuth2\ClientRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
