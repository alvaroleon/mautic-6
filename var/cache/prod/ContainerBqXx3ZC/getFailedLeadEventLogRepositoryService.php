...
class getFailedLeadEventLogRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\CampaignBundle\\Entity\\FailedLeadEventLogRepository'] = new \Mautic\CampaignBundle\Entity\FailedLeadEventLogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
