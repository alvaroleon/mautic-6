...
class getStagesChangeLogRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\LeadBundle\\Entity\\StagesChangeLogRepository'] = new \Mautic\LeadBundle\Entity\StagesChangeLogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
