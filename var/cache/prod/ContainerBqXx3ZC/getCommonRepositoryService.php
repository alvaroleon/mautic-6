...
class getCommonRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\CoreBundle\\Entity\\CommonRepository'] = new \Mautic\CoreBundle\Entity\CommonRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
