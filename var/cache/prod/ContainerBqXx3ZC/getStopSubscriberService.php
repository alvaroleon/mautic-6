...
class getStopSubscriberService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\SmsBundle\\EventListener\\StopSubscriber'] = new \Mautic\SmsBundle\EventListener\StopSubscriber(($container->services['Mautic\\LeadBundle\\Model\\DoNotContact'] ?? self::getDoNotContactService($container)));
    }
}
