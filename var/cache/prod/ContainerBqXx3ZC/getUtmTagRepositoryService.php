...
class getUtmTagRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\LeadBundle\\Entity\\UtmTagRepository'] = new \Mautic\LeadBundle\Entity\UtmTagRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
