...
class getPushIDRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\NotificationBundle\\Entity\\PushIDRepository'] = new \Mautic\NotificationBundle\Entity\PushIDRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
