...
class getSmsTypeService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\SmsBundle\\Form\\Type\\SmsType'] = new \Mautic\SmsBundle\Form\Type\SmsType(($container->services['mautic.permission.manager'] ?? self::getMautic_Permission_ManagerService($container)));
    }
}
