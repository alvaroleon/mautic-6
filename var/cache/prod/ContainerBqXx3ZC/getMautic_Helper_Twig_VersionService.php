...
class getMautic_Helper_Twig_VersionService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['mautic.helper.twig.version'] = new \Mautic\CoreBundle\Twig\Helper\VersionHelper(($container->services['mautic.helper.app_version'] ??= new \Mautic\CoreBundle\Helper\AppVersion()));
    }
}
