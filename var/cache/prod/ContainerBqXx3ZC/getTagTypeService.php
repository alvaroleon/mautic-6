...
class getTagTypeService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\LeadBundle\\Form\\Type\\TagType'] = new \Mautic\LeadBundle\Form\Type\TagType(($container->services['mautic.permission.manager'] ?? self::getMautic_Permission_ManagerService($container)));
    }
}
