...
class getPageRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\PageBundle\\Entity\\PageRepository'] = new \Mautic\PageBundle\Entity\PageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
