...
class getFieldTypeService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Mautic\\LeadBundle\\Form\\Type\\FieldType'] = new \Mautic\LeadBundle\Form\Type\FieldType($a, ($container->services['Mautic\\CoreBundle\\Translation\\Translator'] ?? self::getTranslatorService($container)), ($container->services['mautic.lead.field.identifier_fields'] ?? $container->load('getMautic_Lead_Field_IdentifierFieldsService')), ($container->services['Mautic\\LeadBundle\\Field\\Helper\\IndexHelper'] ?? $container->load('getIndexHelperService')));
    }
}
