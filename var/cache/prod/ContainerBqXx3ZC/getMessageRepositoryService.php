...
class getMessageRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\ChannelBundle\\Entity\\MessageRepository'] = new \Mautic\ChannelBundle\Entity\MessageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
