...
class getAggregatorTypeService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\ReportBundle\\Form\\Type\\AggregatorType'] = new \Mautic\ReportBundle\Form\Type\AggregatorType(($container->services['translator'] ?? self::getTranslator2Service($container)));
    }
}
