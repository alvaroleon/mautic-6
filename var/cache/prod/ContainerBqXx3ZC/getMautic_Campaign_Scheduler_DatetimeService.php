...
class getMautic_Campaign_Scheduler_DatetimeService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['mautic.campaign.scheduler.datetime'] = new \Mautic\CampaignBundle\Executioner\Scheduler\Mode\DateTime(($container->services['monolog.logger.mautic'] ?? self::getMonolog_Logger_MauticService($container)));
    }
}
