...
class getSegmentFilterSubscriberService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Mautic\\PointBundle\\EventListener\\SegmentFilterSubscriber'] = new \Mautic\PointBundle\EventListener\SegmentFilterSubscriber(($container->services['Mautic\\PointBundle\\Entity\\GroupRepository'] ?? $container->load('getGroupRepositoryService')), $a, ($container->services['translator'] ?? self::getTranslator2Service($container)));
    }
}
