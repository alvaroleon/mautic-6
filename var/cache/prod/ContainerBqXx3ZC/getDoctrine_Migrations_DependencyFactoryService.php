...
class getDoctrine_Migrations_DependencyFactoryService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addMigrationsDirectory('Mautic\\Migrations', (\dirname(__DIR__, 4).'/docroot/app/migrations'));
        $a->setCustomTemplate((\dirname(__DIR__, 4).'/docroot/app/migrations/Migration.template'));
