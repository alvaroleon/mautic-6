...
class getCopyRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\EmailBundle\\Entity\\CopyRepository'] = new \Mautic\EmailBundle\Entity\CopyRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
