...
class getRequestStorageHelperService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\EmailBundle\\Helper\\RequestStorageHelper'] = new \Mautic\EmailBundle\Helper\RequestStorageHelper(($container->services['mautic.cache.provider'] ?? self::getMautic_Cache_ProviderService($container)));
    }
}
