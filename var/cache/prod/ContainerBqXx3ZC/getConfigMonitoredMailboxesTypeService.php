...
class getConfigMonitoredMailboxesTypeService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\EmailBundle\\Form\\Type\\ConfigMonitoredMailboxesType'] = new \Mautic\EmailBundle\Form\Type\ConfigMonitoredMailboxesType(($container->services['Mautic\\EmailBundle\\MonitoredEmail\\Mailbox'] ?? self::getMailboxService($container)));
    }
}
