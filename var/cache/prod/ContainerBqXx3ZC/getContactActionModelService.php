...
class getContactActionModelService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\CategoryBundle\\Model\\ContactActionModel'] = new \Mautic\CategoryBundle\Model\ContactActionModel(($container->services['Mautic\\LeadBundle\\Model\\LeadModel'] ?? self::getLeadModelService($container)));
    }
}
