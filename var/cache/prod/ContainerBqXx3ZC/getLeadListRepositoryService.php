...
class getLeadListRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\LeadBundle\\Entity\\LeadListRepository'] = new \Mautic\LeadBundle\Entity\LeadListRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
