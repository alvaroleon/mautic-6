...
class getCampaignRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\CampaignBundle\\Entity\\CampaignRepository'] = new \Mautic\CampaignBundle\Entity\CampaignRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
