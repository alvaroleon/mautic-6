...
class getTweetRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['MauticPlugin\\MauticSocialBundle\\Entity\\TweetRepository'] = new \MauticPlugin\MauticSocialBundle\Entity\TweetRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
