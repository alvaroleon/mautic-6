...
class getWebhookQueueRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\WebhookBundle\\Entity\\WebhookQueueRepository'] = new \Mautic\WebhookBundle\Entity\WebhookQueueRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
