...
class getRoleRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\UserBundle\\Entity\\RoleRepository'] = new \Mautic\UserBundle\Entity\RoleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
