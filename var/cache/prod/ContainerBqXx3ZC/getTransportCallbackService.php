...
class getTransportCallbackService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\EmailBundle\\Model\\TransportCallback'] = new \Mautic\EmailBundle\Model\TransportCallback(($container->services['Mautic\\LeadBundle\\Model\\DoNotContact'] ?? self::getDoNotContactService($container)), ($container->services['mautic.message.search.contact'] ?? $container->load('getMautic_Message_Search_ContactService')), ($container->services['Mautic\\EmailBundle\\Model\\EmailStatModel'] ?? self::getEmailStatModelService($container)));
    }
}
