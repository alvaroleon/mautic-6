...
class getSegmentActionModelService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\LeadBundle\\Model\\SegmentActionModel'] = new \Mautic\LeadBundle\Model\SegmentActionModel(($container->services['Mautic\\LeadBundle\\Model\\LeadModel'] ?? self::getLeadModelService($container)));
    }
}
