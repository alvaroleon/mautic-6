...
class getPageSubscriber4Service extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Mautic\\FormBundle\\EventListener\\PageSubscriber'] = new \Mautic\FormBundle\EventListener\PageSubscriber($a, $b, ($container->services['translator'] ?? self::getTranslator2Service($container)), ($container->services['mautic.security'] ?? self::getMautic_SecurityService($container)));
    }
}
