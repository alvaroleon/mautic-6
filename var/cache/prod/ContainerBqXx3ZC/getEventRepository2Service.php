...
class getEventRepository2Service extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\WebhookBundle\\Entity\\EventRepository'] = new \Mautic\WebhookBundle\Entity\EventRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
