...
class getMautic_Generated_Columns_Doctrine_ListenerService extends AppKernelProdContainer
{
    ...
    {
        $a = ($container->services['mautic.generated.columns.provider'] ?? self::getMautic_Generated_Columns_ProviderService($container));
        ...
        return $container->services['mautic.generated.columns.doctrine.listener'] = new \Mautic\CoreBundle\EventListener\DoctrineGeneratedColumnsListener($a, ($container->services['monolog.logger.mautic'] ?? self::getMonolog_Logger_MauticService($container)));
    }
}
