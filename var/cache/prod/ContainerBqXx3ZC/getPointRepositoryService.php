...
class getPointRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\PointBundle\\Entity\\PointRepository'] = new \Mautic\PointBundle\Entity\PointRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
