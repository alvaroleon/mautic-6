...
class getMautic_Lead_Doctrine_SubscriberService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['mautic.lead.doctrine.subscriber'] = new \Mautic\LeadBundle\EventListener\DoctrineSubscriber(($container->services['monolog.logger.mautic'] ?? self::getMonolog_Logger_MauticService($container)));
    }
}
