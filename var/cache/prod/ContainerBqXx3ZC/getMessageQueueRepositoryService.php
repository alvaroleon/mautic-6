...
class getMessageQueueRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\ChannelBundle\\Entity\\MessageQueueRepository'] = new \Mautic\ChannelBundle\Entity\MessageQueueRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
