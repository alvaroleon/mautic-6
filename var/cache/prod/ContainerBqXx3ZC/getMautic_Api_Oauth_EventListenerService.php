...
class getMautic_Api_Oauth_EventListenerService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['mautic.api.oauth.event_listener'] = new \Mautic\ApiBundle\EventListener\PreAuthorizationEventListener($a, ($container->services['mautic.security'] ?? self::getMautic_SecurityService($container)), ($container->services['translator'] ?? self::getTranslator2Service($container)));
    }
}
