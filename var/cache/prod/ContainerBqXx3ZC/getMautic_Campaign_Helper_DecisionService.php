...
class getMautic_Campaign_Helper_DecisionService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['mautic.campaign.helper.decision'] = new \Mautic\CampaignBundle\Executioner\Helper\DecisionHelper(($container->services['Mautic\\CampaignBundle\\Entity\\LeadRepository'] ?? self::getLeadRepositoryService($container)));
    }
}
