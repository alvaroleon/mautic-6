...
class getTriggerRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\PointBundle\\Entity\\TriggerRepository'] = new \Mautic\PointBundle\Entity\TriggerRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
