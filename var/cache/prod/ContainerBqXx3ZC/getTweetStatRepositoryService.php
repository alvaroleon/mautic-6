...
class getTweetStatRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['MauticPlugin\\MauticSocialBundle\\Entity\\TweetStatRepository'] = new \MauticPlugin\MauticSocialBundle\Entity\TweetStatRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
