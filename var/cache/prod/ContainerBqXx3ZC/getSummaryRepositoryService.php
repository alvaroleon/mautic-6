...
class getSummaryRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\CampaignBundle\\Entity\\SummaryRepository'] = new \Mautic\CampaignBundle\Entity\SummaryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
