...
class getUserSubscriberService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Mautic\\UserBundle\\EventListener\\UserSubscriber'] = new \Mautic\UserBundle\EventListener\UserSubscriber(($container->services['mautic.helper.ip_lookup'] ?? self::getMautic_Helper_IpLookupService($container)), $a);
    }
}
