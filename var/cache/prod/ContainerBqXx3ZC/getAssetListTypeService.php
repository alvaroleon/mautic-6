...
class getAssetListTypeService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Mautic\\AssetBundle\\Form\\Type\\AssetListType'] = new \Mautic\AssetBundle\Form\Type\AssetListType(($container->services['mautic.security'] ?? self::getMautic_SecurityService($container)), $a, ($container->services['mautic.helper.user'] ?? self::getMautic_Helper_UserService($container)));
    }
}
