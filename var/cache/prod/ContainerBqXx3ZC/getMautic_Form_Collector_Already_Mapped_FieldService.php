...
class getMautic_Form_Collector_Already_Mapped_FieldService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['mautic.form.collector.already.mapped.field'] = new \Mautic\FormBundle\Collector\AlreadyMappedFieldCollector(($container->services['mautic.cache.provider'] ?? self::getMautic_Cache_ProviderService($container)));
    }
}
