...
class getAssetRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\AssetBundle\\Entity\\AssetRepository'] = new \Mautic\AssetBundle\Entity\AssetRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
