...
class getEventRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\CampaignBundle\\Entity\\EventRepository'] = new \Mautic\CampaignBundle\Entity\EventRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
