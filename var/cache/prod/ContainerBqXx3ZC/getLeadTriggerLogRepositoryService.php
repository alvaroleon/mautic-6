...
class getLeadTriggerLogRepositoryService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\PointBundle\\Entity\\LeadTriggerLogRepository'] = new \Mautic\PointBundle\Entity\LeadTriggerLogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
