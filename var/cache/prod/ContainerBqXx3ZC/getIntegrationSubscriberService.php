...
class getIntegrationSubscriberService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\PluginBundle\\EventListener\\IntegrationSubscriber'] = new \Mautic\PluginBundle\EventListener\IntegrationSubscriber(($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)));
    }
}
