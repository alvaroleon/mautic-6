...
class getUpdateCustomFieldCommandService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\LeadBundle\\Field\\Command\\UpdateCustomFieldCommand'] = new \Mautic\LeadBundle\Field\Command\UpdateCustomFieldCommand(($container->services['mautic.lead.field.settings.background_service'] ?? $container->load('getMautic_Lead_Field_Settings_BackgroundServiceService')), ($container->services['translator'] ?? self::getTranslator2Service($container)));
    }
}
