...
class getModifyLeadTagsTypeService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['Mautic\\LeadBundle\\Form\\Type\\ModifyLeadTagsType'] = new \Mautic\LeadBundle\Form\Type\ModifyLeadTagsType(($container->services['translator'] ?? self::getTranslator2Service($container)));
    }
}
