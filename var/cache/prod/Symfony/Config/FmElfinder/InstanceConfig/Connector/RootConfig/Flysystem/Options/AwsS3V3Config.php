...
class AwsS3V3Config 
{
     ...
     * @return $this
     */
    public function useAwsSharedConfigFiles($value): static
    {
        $this->_usedProperties['useAwsSharedConfigFiles'] = true;
        $this->useAwsSharedConfigFiles = $value;
     ...
     * @psalm-return (TValue is array ? \Symfony\Config\FmElfinder\InstanceConfig\Connector\RootConfig\Flysystem\Options\AwsS3V3\OptionsConfig : static)
     */
    public function options(array $value = []): \Symfony\Config\FmElfinder\InstanceConfig\Connector\RootConfig\Flysystem\Options\AwsS3V3\OptionsConfig|static
    {
        if (!\is_array($value)) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('use_aws_shared_config_files', $value)) {
            $this->_usedProperties['useAwsSharedConfigFiles'] = true;
            $this->useAwsSharedConfigFiles = $value['use_aws_shared_config_files'];
            unset($value['use_aws_shared_config_files']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['useAwsSharedConfigFiles'])) {
            $output['use_aws_shared_config_files'] = $this->useAwsSharedConfigFiles;
        }
