...
class __TwigTemplate_abad0e5ce9fe45b009395004becd9b99 extends Template
{
    ...
    <div class=\"dropdown-menu\">
        ...
        yield "
                        ";
        // line 12
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["notifications"]) || array_key_exists("notifications", $context) ? $context["notifications"] : (function () { throw new RuntimeError('Variable "notifications" does not exist.', 12, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 13
            yield "                            ";
            yield from $this->load("@MauticCore/Helper/button.html.twig", 13)->unwrap()->yield(CoreExtension::merge($context, ["buttons" => [["label" => "mautic.core.notifications.clearall", "variant" => "ghost", "size" => "xs", "icon_only" => true, "icon" => "ri-delete-bin-2-line", "attributes" => ["class" => "pull-right"], "onclick" => "Mautic.clearNotification(0);"]]]));
            // line 28
            yield "                        ";
        }
        // line 29
...
(isset($context["updateMessage"]) || array_key_exists("updateMessage", $context) ? $context["updateMessage"] : (function () { throw new RuntimeError('Variable "updateMessage" does not exist.', 36, $this->source); })())]);
        ...
        yield "
                    ";
        // line 38
        $context["class"] = (((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["notifications"]) || array_key_exists("notifications", $context) ? $context["notifications"] : (function () { throw new RuntimeError('Variable "notifications" does not exist.', 38, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (" hide") : (""));
        // line 39
        yield "                    <div class=\"";
...
";
    ...
    {
        return new Source("", "@MauticCore/Notification/notifications.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Notification/notifications.html.twig");
    }
}
