...
class __TwigTemplate_c0cf14e1fd62ce151ce5bd51a88b2907 extends Template
{
    ...
    <ul class=\"dropdown-menu dropdown-menu-right\">
        ...
        yield "</span>
                    ";
        // line 12
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 12, $this->source); })()), "getUser", [], "method", false, false, false, 12), "getPosition", [], "method", false, false, false, 12)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 13
        ...
        ";
        // line 25
        if ((($tmp = $this->extensions['Mautic\CoreBundle\Twig\Extension\SecurityExtension']->isGranted("user:users:create")) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 26
            yield "        <li>
            <a href=\"";
            // line 27
        ...
        ";
        // line 40
        if ((($tmp = (isset($context["inline"]) || array_key_exists("inline", $context) ? $context["inline"] : (function () { throw new RuntimeError('Variable "inline" does not exist.', 40, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 41
    ...
    {
        return new Source("", "@MauticCore/Menu/profile.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Menu/profile.html.twig");
    }
}
