...
class __TwigTemplate_9296897e76571490670bf6ff8bd79a18 extends Template
{
...
";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["entity"] ?? null), "getCreateByUser", [], "any", true, true, false, 9)) {
            // line 10
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["entity"]) || array_key_exists("entity", $context) ? $context["entity"] : (function () { throw new RuntimeError('Variable "entity" does not exist.', 10, $this->source); })()), "getCreatedByUser", [], "method", false, false, false, 10)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 11
                yield "<tr>
    <td width=\"20%\"><span class=\"fw-b textTitle\">";
                // line 12
...
";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["entity"] ?? null), "getModifiedByUser", [], "any", true, true, false, 21)) {
            ...
            // line 23
            if ((($tmp = (isset($context["modified"]) || array_key_exists("modified", $context) ? $context["modified"] : (function () { throw new RuntimeError('Variable "modified" does not exist.', 23, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 24
                yield "    <tr>
        <td width=\"20%\"><span class=\"fw-b textTitle\">";
                // line 25
...
";
    ...
    <td>";
            // line 37
            yield (((($tmp =  !(null === CoreExtension::getAttribute($this->env, $this->source, (isset($context["entity"]) || array_key_exists("entity", $context) ? $context["entity"] : (function () { throw new RuntimeError('Variable "entity" does not exist.', 37, $this->source); })()), "getPublishUp", [], "method", false, false, false, 37))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->extensions['Mautic\CoreBundle\Twig\Extension\DateExtension']->toFull(CoreExtension::getAttribute($this->env, $this->source, (isset($context["entity"]) || array_key_exists("entity", $context) ? $context["entity"] : (function () { throw new RuntimeError('Variable "entity" does not exist.', 37, $this->source); })()), "getPublishUp", [], "method", false, false, false, 37))) : ($this->extensions['Mautic\CoreBundle\Twig\Extension\DateExtension']->toFull(CoreExtension::getAttribute($this->env, $this->source, (isset($context["entity"]) || array_key_exists("entity", $context) ? $context["entity"] : (function () { throw new RuntimeError('Variable "entity" does not exist.', 37, $this->source); })()), "getDateAdded", [], "method", false, false, false, 37))));
            yield "</td>
</tr>
<tr>
    <td width=\"20%\"><span class=\"fw-b textTitle\">";
    ...
    <td>";
            // line 41
            yield (((($tmp =  !(null === CoreExtension::getAttribute($this->env, $this->source, (isset($context["entity"]) || array_key_exists("entity", $context) ? $context["entity"] : (function () { throw new RuntimeError('Variable "entity" does not exist.', 41, $this->source); })()), "getPublishDown", [], "method", false, false, false, 41))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->extensions['Mautic\CoreBundle\Twig\Extension\DateExtension']->toFull(CoreExtension::getAttribute($this->env, $this->source, (isset($context["entity"]) || array_key_exists("entity", $context) ? $context["entity"] : (function () { throw new RuntimeError('Variable "entity" does not exist.', 41, $this->source); })()), "getPublishDown", [], "method", false, false, false, 41))) : ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("mautic.core.never"), "html", null, true)));
            yield "</td>
</tr>
";
        }
...
";
    ...
    {
        return new Source("", "@MauticCore/Helper/details.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Helper/details.html.twig");
    }
}
