...
class __TwigTemplate_9d6884304f33e231a3e158beace71c5e extends Template
{
...
<div class=\"navbar-nocollapse\">
    ...
    <ul class=\"nav navbar-nav navbar-left\">
        ...
        ";
        // line 56
        yield from $this->load("@MauticCore/Helper/button.html.twig", 56)->unwrap()->yield(CoreExtension::merge($context, ["buttons" => [["label" => "mautic.core.search_everything", "tooltip_placement" => "right", "variant" => "ghost", "icon" => "ri-search-line ri-xl", "icon_only" => true, "attributes" => ["type" => "button", "data-toggle" => "modal", "data-target" => "#gsearchModal", "class" => "search-button"]]]]));
        // line 73
        yield "
    </ul>
    <!--/ end: left nav -->
...
";
    ...
    {
        return new Source("", "@MauticCore/Default/navbar.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Default/navbar.html.twig");
    }
}
