...
class __TwigTemplate_0d60c75e44e412bd301c23e2fee2887c extends Template
{
...
<div class=\"panel-heading pa-0 toolbar--table-toolbar\">
    ...
    <div class=\"toolbar--batch-actions d-flex jc-space-between bg-primary fd-column fd-row-sm\">
        ...
        yield "
            ...
            ";
        // line 13
        yield from $this->load("@MauticCore/Helper/button.html.twig", 13)->unwrap()->yield(CoreExtension::merge($context, ["buttons" => [["label" => "mautic.core.form.cancel", "variant" => "primary", "size" => "lg", "attributes" => ["type" => "button", "class" => "bdr-rds-0", "data-toggle" => "cancel-checkall"]]]]));
        // line 27
        yield "        </div>
    </div>
...
array_key_exists("overlayDisabled", $context)) ? ((isset($context["overlayDisabled"]) || array_key_exists("overlayDisabled", $context) ? $context["overlayDisabled"] : (function () { throw new RuntimeError('Variable "overlayDisabled" does not exist.', 39, $this->source); })())) : (null))]);
        ...
        ";
        // line 43
        yield from $this->load("@MauticCore/Helper/toolbar_actions.html.twig", 43)->unwrap()->yield($context);
        // line 44
        yield "        ";
...
";
    ...
    {
        return new Source("", "@MauticCore/Helper/list_toolbar.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Helper/list_toolbar.html.twig");
    }
}
