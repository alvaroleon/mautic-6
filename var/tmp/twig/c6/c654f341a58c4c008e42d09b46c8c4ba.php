...
class __TwigTemplate_6eacc96d45c92a7cd901feb4ea13147e extends Template
{
  ...
  ";
        // line 16
        if ((($tmp = (isset($context["isIndex"]) || array_key_exists("isIndex", $context) ? $context["isIndex"] : (function () { throw new RuntimeError('Variable "isIndex" does not exist.', 16, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 17
            yield "        </div>
    </div>
    ";
  ...
  ";
    ...
    {
        return new Source("", "@MauticLead/Lead/list.html.twig", "/var/www/html/docroot/app/bundles/LeadBundle/Resources/views/Lead/list.html.twig");
    }
}
