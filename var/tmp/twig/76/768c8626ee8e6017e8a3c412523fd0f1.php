...
class __TwigTemplate_91d6146589e89e242c07588a0492458d extends Template
{
...
";
        // line 8
        yield from $this->load("@MauticCore/Helper/button.html.twig", 8)->unwrap()->yield(CoreExtension::merge($context, ["buttons" => [["label" => "mautic.core.search.clear", "variant" => "ghost", "icon" => "ri-search-line ri-fw", "icon_only" => true, "size" => "lg", "attributes" => ["type" => "button", "id" => "btn-filter", "data-livesearch-parent" =>         // line 19
...
<div class=\"row\">
    <div class=\"footer-buttons d-flex fw-nowrap gap-1 mt-lg\">
        ";
                // line 53
                yield from $this->load("@MauticCore/Helper/button.html.twig", 53)->unwrap()->yield(CoreExtension::merge($context, ["buttons" => [["label" => "mautic.core.reset_filter", "variant" => "secondary", "onclick" => "Mautic.resetFilters()", "size" => "lg"], ["label" => "mautic.core.apply_filter", "variant" => "primary", "onclick" => "Mautic.applyFilters()", "size" => "lg"]]]));
                // line 69
                yield "    </div>
</div>
";
...
";
            // line 73
            yield from $this->load("@MauticCore/Helper/button.html.twig", 73)->unwrap()->yield(CoreExtension::merge($context, ["buttons" => [["variant" => "ghost", "icon_only" => true, "icon" => "ri-filter-line ri-1x", "attributes" => ["type" => "button", "data-container" => "body", "data-toggle" => "popover", "data-html" => "true", "data-placement" => "left", "data-content" =>             // line 85
(isset($context["filtering"]) || array_key_exists("filtering", $context) ? $context["filtering"] : (function () { throw new RuntimeError('Variable "filtering" does not exist.', 85, $this->source); })())], "label" => "mautic.core.quick_filters"]]]));
    ...
    {
        return new Source("", "@MauticCore/Helper/search.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Helper/search.html.twig");
    }
}
