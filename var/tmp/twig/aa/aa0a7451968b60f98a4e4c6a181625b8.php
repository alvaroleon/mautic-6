...
class __TwigTemplate_45d1b9eef21bbc2bc2536c3bb49f909c extends Template
{
    ...
    {
        // line 7
        return $this->load((((($tmp = (isset($context["isIndex"]) || array_key_exists("isIndex", $context) ? $context["isIndex"] : (function () { throw new RuntimeError('Variable "isIndex" does not exist.', 7, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("@MauticCore/Default/content.html.twig") : ("@MauticCore/Default/raw_output.html.twig")), 7);
    }
...
";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        // line 24
        yield "  ";
        if ((($tmp = (isset($context["isIndex"]) || array_key_exists("isIndex", $context) ? $context["isIndex"] : (function () { throw new RuntimeError('Variable "isIndex" does not exist.', 24, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 25
  ...
  ";
        // line 31
        if ((($tmp = (isset($context["isIndex"]) || array_key_exists("isIndex", $context) ? $context["isIndex"] : (function () { throw new RuntimeError('Variable "isIndex" does not exist.', 31, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 32
            yield "        </div>
    </div>
  ";
    ...
    {
        return new Source("", "@MauticLead/Import/list.html.twig", "/var/www/html/docroot/app/bundles/LeadBundle/Resources/views/Import/list.html.twig");
    }
}
