...
class __TwigTemplate_225ca97f3ef844675cab9354ec8a56d8 extends Template
{
    ...
    {
        // line 21
        return $this->load((isset($context["baseTemplate"]) || array_key_exists("baseTemplate", $context) ? $context["baseTemplate"] : (function () { throw new RuntimeError('Variable "baseTemplate" does not exist.', 21, $this->source); })()), 21);
    }
    ...
    public function block__content(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp = (isset($context["isInline"]) || array_key_exists("isInline", $context) ? $context["isInline"] : (function () { throw new RuntimeError('Variable "isInline" does not exist.', 29, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield " inline well";
        }
        yield "\">
        <div class=\"row mt-lg pa-md\">
            ";
        // line 31
        if ((($tmp = (isset($context["isInline"]) || array_key_exists("isInline", $context) ? $context["isInline"] : (function () { throw new RuntimeError('Variable "isInline" does not exist.', 31, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 32
...
";
    ...
    {
        return new Source("", "@MauticCore/Error/base.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Error/base.html.twig");
    }
}
