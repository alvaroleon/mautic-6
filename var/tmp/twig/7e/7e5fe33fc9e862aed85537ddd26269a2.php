...
class __TwigTemplate_fe0ca3abd4203f47b9d7664c73fa83d8 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        // line 10
        $this->parent = $this->load("@MauticCore/Default/content.html.twig", 10);
    ...
    public function block_headerTitle(array $context, array $blocks = []): iterable
    {
        ...
        // line 15
        yield "  ";
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 15, $this->source); })()), "vars", [], "any", false, false, false, 15), "data", [], "any", false, false, false, 15), "id", [], "any", false, false, false, 15))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 16
...
<div class=\"box-layout\">
    <div class=\"col-md-9 height-auto\">
        ...
        // line 31
        if ((($tmp = $this->extensions['Mautic\CoreBundle\Twig\Extension\FormExtension']->containsErrors((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 31, $this->source); })()), ["filters"])) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield "text-danger";
        }
        yield "\">
                            ";
        ...
        yield "
                            ";
        // line 33
        if ((($tmp = $this->extensions['Mautic\CoreBundle\Twig\Extension\FormExtension']->containsErrors((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 33, $this->source); })()), ["filters"])) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 34
        ...
        // line 39
        if ((($tmp = $this->extensions['Mautic\CoreBundle\Twig\Extension\FormExtension']->containsErrors(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 39, $this->source); })()), "filters", [], "any", false, false, false, 39))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield "text-danger";
        }
        yield "\">
                            ";
        ...
        yield "
                            ";
        // line 41
        if ((($tmp = $this->extensions['Mautic\CoreBundle\Twig\Extension\FormExtension']->containsErrors(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 41, $this->source); })()), "filters", [], "any", false, false, false, 41))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 42
            yield "                                <i class=\"ri-alert-line\"></i>
                            ";
        }
        ...
        foreach ($context['_seq'] as $context["object"] => $context["field"]) {
            ...
            // line 76
            yield "                                      ";
            $context["header"] = (((($tmp = $this->extensions['Mautic\CoreBundle\Twig\Extension\TranslatorExtension']->translatorHasId(("mautic.lead." . $context["object"]))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(("mautic.lead." . $context["object"]))) : ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans($context["object"])));
            // line 77
            ...
            foreach ($context['_seq'] as $context["value"] => $context["params"]) {
                // line 79
                yield "                                              ";
                $context["operators"] = (((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["params"], "operators", [], "any", false, false, false, 79))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (json_encode(CoreExtension::getAttribute($this->env, $this->source, $context["params"], "operators", [], "any", false, false, false, 79))) : ("{}"));
                // line 80
                yield "                                              <option value=\"";
        ...
        yield "                                </select>
                        ...
                        <div class=\"selected-filters\" id=\"leadlist_filters\">
                            ";
        // line 96
        if ((($tmp = $this->extensions['Mautic\CoreBundle\Twig\Extension\FormExtension']->containsErrors(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 96, $this->source); })()), "filters", [], "any", false, false, false, 96))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 97
...
";
    ...
    {
        return new Source("", "@MauticLead/List/form.html.twig", "/var/www/html/docroot/app/bundles/LeadBundle/Resources/views/List/form.html.twig");
    }
}
