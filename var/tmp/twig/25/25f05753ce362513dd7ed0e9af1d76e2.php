...
class __TwigTemplate_75395c77a6fb7e3866ae0a4ee238aba0 extends Template
{
    ...
    ";
        ...
        // line 3
        yield "    ";
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["flag"]) || array_key_exists("flag", $context) ? $context["flag"] : (function () { throw new RuntimeError('Variable "flag" does not exist.', 3, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 4
            yield "        <img src=\"";
...
";
    ...
    {
        return new Source("", "@MauticLead/Lead/_list_column_location.html.twig", "/var/www/html/docroot/app/bundles/LeadBundle/Resources/views/Lead/_list_column_location.html.twig");
    }
}
