...
class __TwigTemplate_50d5ebc453075bf8e5815b2aede692ab extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        if ((($tmp = (isset($context["upcomingEmails"]) || array_key_exists("upcomingEmails", $context) ? $context["upcomingEmails"] : (function () { throw new RuntimeError('Variable "upcomingEmails" does not exist.', 1, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 2
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["email"]) {
                ...
                yield "
                            ";
                // line 20
                yield from $this->load("@MauticCore/Helper/button.html.twig", 20)->unwrap()->yield(CoreExtension::merge($context, ["buttons" => [["label" => ((CoreExtension::getAttribute($this->env, $this->source,                 // line 23
...
";
    ...
    {
        return new Source("", "@MauticDashboard/Dashboard/upcomingemails.html.twig", "/var/www/html/docroot/app/bundles/DashboardBundle/Resources/views/Dashboard/upcomingemails.html.twig");
    }
}
