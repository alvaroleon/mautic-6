...
class __TwigTemplate_42e529bc0cc7046f3227d688f2c91554 extends Template
{
...
";
    ...
    ";
            // line 19
            if ((($tmp = (isset($context["icon_only"]) || array_key_exists("icon_only", $context) ? $context["icon_only"] : (function () { throw new RuntimeError('Variable "icon_only" does not exist.', 19, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 20
                yield "        ";
            ...
            // line 22
            yield "    ";
            if ((($tmp = (isset($context["danger_modifier"]) || array_key_exists("danger_modifier", $context) ? $context["danger_modifier"] : (function () { throw new RuntimeError('Variable "danger_modifier" does not exist.', 22, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 23
                yield "        ";
            ...
            // line 25
            yield "    ";
            if ((($tmp = (isset($context["wide_modifier"]) || array_key_exists("wide_modifier", $context) ? $context["wide_modifier"] : (function () { throw new RuntimeError('Variable "wide_modifier" does not exist.', 25, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 26
                yield "        ";
            ...
            // line 28
            yield "    ";
            if ((($tmp = (isset($context["spin"]) || array_key_exists("spin", $context) ? $context["spin"] : (function () { throw new RuntimeError('Variable "spin" does not exist.', 28, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 29
                yield "        ";
    ...
    {
        return new Source("", "@MauticCore/Helper/button.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Helper/button.html.twig");
    }
}
