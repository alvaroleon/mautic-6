...
class __TwigTemplate_3d4ce95db696500051faed65f2743388 extends Template
{
    ...
    {
        // line 14
        return $this->load((((($tmp = (isset($context["isIndex"]) || array_key_exists("isIndex", $context) ? $context["isIndex"] : (function () { throw new RuntimeError('Variable "isIndex" does not exist.', 14, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("@MauticCore/Default/content.html.twig") : ("@MauticCore/Default/raw_output.html.twig")), 14);
    }
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        // line 23
        yield "  ";
        if ((($tmp = (isset($context["isIndex"]) || array_key_exists("isIndex", $context) ? $context["isIndex"] : (function () { throw new RuntimeError('Variable "isIndex" does not exist.', 23, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 24
            yield "    <div id=\"page-list-wrapper\" class=\"panel panel-default\">";
            // line 25
            $context["pageButtons"] = [];
            // line 26
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["permissions"]) || array_key_exists("permissions", $context) ? $context["permissions"] : (function () { throw new RuntimeError('Variable "permissions" does not exist.', 26, $this->source); })()), "lead:leads:create", [], "array", false, false, false, 26)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 27
                yield "    ";
...
(isset($context["limit"]) || array_key_exists("limit", $context) ? $context["limit"] : (function () { throw new RuntimeError('Variable "limit" does not exist.', 179, $this->source); })()), "menuLinkId" => "mautic_company_index", "baseUrl" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("mautic_company_index"), "sessionVar" => "company"]);
  ...
  ";
        // line 189
        if ((($tmp = (isset($context["isIndex"]) || array_key_exists("isIndex", $context) ? $context["isIndex"] : (function () { throw new RuntimeError('Variable "isIndex" does not exist.', 189, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 190
            yield "        </div>
    </div>
  ";
    ...
    {
        return new Source("", "@MauticLead/Company/list.html.twig", "/var/www/html/docroot/app/bundles/LeadBundle/Resources/views/Company/list.html.twig");
    }
}
