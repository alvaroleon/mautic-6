...
class __TwigTemplate_e7bbf86b070abb3d405613702f67bae2 extends Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["type"] => $context["item"]) {
            // line 10
            $context["messages"] = (((($tmp =  !is_iterable($context["item"])) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ([$context["item"]]) : ($context["item"]));
            // line 11
            yield "    ";
            $context['_parent'] = $context;
    ...
    {
        return new Source("", "@MauticCore/Notification/flash_messages.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Notification/flash_messages.html.twig");
    }
}
