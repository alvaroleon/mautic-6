...
class __TwigTemplate_9d6b30425de1f9ce01c3630c66207a79 extends Template
{
...
<div class=\"pa-sm\" id=\"globalSearchPanel\">
    ";
        // line 17
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["results"]) || array_key_exists("results", $context) ? $context["results"] : (function () { throw new RuntimeError('Variable "results" does not exist.', 17, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 18
            ...
            foreach ($context['_seq'] as $context["header"] => $context["result"]) {
                // line 19
                yield "            ";
                if ((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, false, 19)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 20
            ...
            <div class=\"text-secondary pl-sm pr-sm ml-2 mr-2 mb-xs d-flex gap-xs";
                // line 23
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, false, 23)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    yield " mt-md";
                }
                yield "\">
                ";
            ...
            <div class=\"np\">
                ...
                foreach ($context['_seq'] as $context["k"] => $context["r"]) {
                    // line 33
                    yield "                        ";
                    if ((($tmp =  !("count" === $context["k"])) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 34
...
";
    ...
    {
        return new Source("", "@MauticCore/GlobalSearch/results.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/GlobalSearch/results.html.twig");
    }
}
