...
class __TwigTemplate_516fbe35cf1d8a70915cb768052b3875 extends Template
{
    ...
    <td class=\"visible-md visible-lg\">";
        // line 30
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["item"]) || array_key_exists("item", $context) ? $context["item"] : (function () { throw new RuntimeError('Variable "item" does not exist.', 30, $this->source); })()), "runTime", [], "any", false, false, false, 30)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
    ...
    <td class=\"visible-md visible-lg\">
        ";
        // line 33
        if ((($tmp =  !(null === (isset($context["objectRoute"]) || array_key_exists("objectRoute", $context) ? $context["objectRoute"] : (function () { throw new RuntimeError('Variable "objectRoute" does not exist.', 33, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 34
    ...
    <td class=\"visible-md visible-lg\">
        ";
        // line 40
        if ((($tmp =  !(null === (isset($context["objectRoute"]) || array_key_exists("objectRoute", $context) ? $context["objectRoute"] : (function () { throw new RuntimeError('Variable "objectRoute" does not exist.', 40, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 41
            yield "            <a size=\"sm\" class=\"mt-xs label label-gray\" href=\"";
    ...
    <td class=\"visible-md visible-lg\">
        ";
        // line 47
        if ((($tmp =  !(null === (isset($context["objectRoute"]) || array_key_exists("objectRoute", $context) ? $context["objectRoute"] : (function () { throw new RuntimeError('Variable "objectRoute" does not exist.', 47, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 48
            yield "            <a size=\"sm\" class=\"mt-xs label label-gray\" href=\"";
...
";
    ...
    {
        return new Source("", "@MauticLead/Import/_list_row.html.twig", "/var/www/html/docroot/app/bundles/LeadBundle/Resources/views/Import/_list_row.html.twig");
    }
}
