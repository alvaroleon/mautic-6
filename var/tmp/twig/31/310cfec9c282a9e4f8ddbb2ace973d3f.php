...
class __TwigTemplate_3ffad4b5f4fd1071704181b9f9ac1eba extends Template
{
    ...
    ";
        ...
        ";
                // line 5
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["child"], "isDisplayed", [], "method", false, false, false, 5)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 6
                    yield "
            ";
                    // line 7
            ...
            ";
                ...
                ";
                    ...
                    ";
                        ...
                        ";
                        // line 40
                        $context["labelClasses"] = (((($tmp = (!CoreExtension::getAttribute($this->env, $this->source, ($context["labelAttributes"] ?? null), "class", [], "any", true, true, false, 40))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("text") : ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["labelAttributes"]) || array_key_exists("labelAttributes", $context) ? $context["labelAttributes"] : (function () { throw new RuntimeError('Variable "labelAttributes" does not exist.', 40, $this->source); })()), "class", [], "any", false, false, false, 40) . " text")));
                        // line 41
                        yield "                        ";
...
";
    ...
    {
        return new Source("", "@MauticCore/Menu/profile_inline.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Menu/profile_inline.html.twig");
    }
}
