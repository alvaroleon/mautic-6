...
class __TwigTemplate_08ecc67fafee238282a4e58d924ef5ad extends Template
{
    ...
    {
        // line 1
        return $this->load((((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 1, $this->source); })()), "request", [], "any", false, false, false, 1), "xmlHttpRequest", [], "any", false, false, false, 1)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("@MauticCore/Default/content.html.twig") : ("@MauticUser/Security/base.html.twig")), 1);
    }
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    ";
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 6, $this->source); })()), "request", [], "any", false, false, false, 6), "xmlHttpRequest", [], "any", false, false, false, 6)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 7
            yield "        <div class=\"row\">
...
\t\t";
        // line 44
        yield from $this->load("@MauticCore/Helper/button.html.twig", 44)->unwrap()->yield(CoreExtension::merge($context, ["buttons" => [["label" => "mautic.user.auth.form.loginbtn", "variant" => "primary", "size" => "lg", "wide" => true]]]));
        // line 54
        yield "
...
\t";
        // line 59
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["integrations"]) || array_key_exists("integrations", $context) ? $context["integrations"] : (function () { throw new RuntimeError('Variable "integrations" does not exist.', 59, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 60
...
\t";
    ...
    {
        return new Source("", "@MauticUser/Security/login.html.twig", "/var/www/html/docroot/app/bundles/UserBundle/Resources/views/Security/login.html.twig");
    }
}
