...
class __TwigTemplate_007ddec4867a16794fde7e37adf35bb3 extends Template
{
    ...
    <ul";
        ...
        ";
            ...
            ";
                // line 14
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["child"], "isDisplayed", [], "method", false, false, false, 14)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 15
                    yield "
                ";
                    // line 16
                ...
                ";
                    ...
                    <li";
                        ...
                        yield "                        
                            ";
                        // line 47
                        $context["labelClasses"] = (((($tmp = (!CoreExtension::getAttribute($this->env, $this->source, ($context["labelAttributes"] ?? null), "class", [], "any", true, true, false, 47))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("text") : ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["labelAttributes"]) || array_key_exists("labelAttributes", $context) ? $context["labelAttributes"] : (function () { throw new RuntimeError('Variable "labelAttributes" does not exist.', 47, $this->source); })()), "class", [], "any", false, false, false, 47) . " text")));
                        // line 48
                        yield "                            ";
...
";
    ...
    {
        return new Source("", "@MauticCore/Menu/extra.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Menu/extra.html.twig");
    }
}
