...
class __TwigTemplate_3513dff0ff4f249a7ae373590047a78d extends Template
{
...
";
        // line 11
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["templateButtons"]) || array_key_exists("templateButtons", $context) ? $context["templateButtons"] : (function () { throw new RuntimeError('Variable "templateButtons" does not exist.', 11, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 12
            yield "    ";
...
<div class=\"dropdown\">
    ";
        // line 20
        if ((($tmp = (isset($context["dropdownItems"]) || array_key_exists("dropdownItems", $context) ? $context["dropdownItems"] : (function () { throw new RuntimeError('Variable "dropdownItems" does not exist.', 20, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 21
            yield "    ";
            yield from $this->load("@MauticCore/Helper/button.html.twig", 21)->unwrap()->yield(CoreExtension::merge($context, ["buttons" => [["variant" => "ghost", "label" => "mautic.core.options", "icon_only" => true, "icon" => "ri-settings-5-line ri-1x", "attributes" => ["class" => "dropdown-toggle", "data-toggle" => "dropdown", "aria-expanded" => "false", "type" => "button", "id" => "page-list-actions"]]]]));
            // line 38
            yield "
...
";
    ...
    {
        return new Source("", "@MauticCore/Helper/toolbar_page_actions.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Helper/toolbar_page_actions.html.twig");
    }
}
