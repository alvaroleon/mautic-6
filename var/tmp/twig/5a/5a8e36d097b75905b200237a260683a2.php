...
class __TwigTemplate_78ffbeadc381a8b108344b83878b279d extends Template
{
    ...
    <div class=\"card-header d-flex jc-space-between ai-center\">
        ...
        ";
        // line 4
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["widget"]) || array_key_exists("widget", $context) ? $context["widget"] : (function () { throw new RuntimeError('Variable "widget" does not exist.', 4, $this->source); })()), "id", [], "any", false, false, false, 4)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 5
            yield "            <div class=\"dropdown\">
                ...
                <ul class=\"dropdown-menu dropdown-menu-right\">
                    <li class=\"small fw-sb text-secondary ma-md ellipsis\">
                        ";
            // line 11
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["widget"]) || array_key_exists("widget", $context) ? $context["widget"] : (function () { throw new RuntimeError('Variable "widget" does not exist.', 11, $this->source); })()), "isCached", [], "any", false, false, false, 11)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 12
    ...
    <div class=\"card-body\">
        ";
        // line 46
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["widget"]) || array_key_exists("widget", $context) ? $context["widget"] : (function () { throw new RuntimeError('Variable "widget" does not exist.', 46, $this->source); })()), "errorMessage", [], "any", false, false, false, 46)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 47
...
(isset($context["widget"]) || array_key_exists("widget", $context) ? $context["widget"] : (function () { throw new RuntimeError('Variable "widget" does not exist.', 50, $this->source); })()), "template", [], "any", false, false, false, 50)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 51
            yield "            <!-- start: ";
...
";
    ...
    {
        return new Source("", "@MauticDashboard/Widget/detail.html.twig", "/var/www/html/docroot/app/bundles/DashboardBundle/Resources/views/Widget/detail.html.twig");
    }
}
