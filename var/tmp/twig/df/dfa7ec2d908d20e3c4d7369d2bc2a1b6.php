...
class __TwigTemplate_414b044d9fb2a44253126aad68d3a046 extends Template
{
...
<div class=\"label label-";
    ...
    ";
        // line 33
        if ((($tmp =  !(array_key_exists("simplified", $context) && (isset($context["simplified"]) || array_key_exists("simplified", $context) ? $context["simplified"] : (function () { throw new RuntimeError('Variable "simplified" does not exist.', 33, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 34
...
";
    ...
    {
        return new Source("", "@MauticCore/Helper/publishstatus_badge.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Helper/publishstatus_badge.html.twig");
    }
}
