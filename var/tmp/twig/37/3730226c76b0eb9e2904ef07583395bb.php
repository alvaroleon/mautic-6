...
class __TwigTemplate_e906fc3930aaa2d30a47ccb973ea6d87 extends Template
{
...
<div class=\"modal fade";
    ...
    <div class=\"modal-dialog";
        ...
        yield "\">
            ";
        // line 16
        if ((($tmp =  !((isset($context["header"]) || array_key_exists("header", $context) ? $context["header"] : (function () { throw new RuntimeError('Variable "header" does not exist.', 16, $this->source); })()) === false)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 17
            yield "            <div class=\"modal-header\">
                ";
            // line 18
            if ((($tmp = (isset($context["dismissable"]) || array_key_exists("dismissable", $context) ? $context["dismissable"] : (function () { throw new RuntimeError('Variable "dismissable" does not exist.', 18, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 19
...
";
    ...
    {
        return new Source("", "@MauticCore/Helper/modal.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Helper/modal.html.twig");
    }
}
