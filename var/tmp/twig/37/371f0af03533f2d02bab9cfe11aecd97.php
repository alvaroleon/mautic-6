...
class __TwigTemplate_be403eb9ac18885815437c1d8583e7d1 extends Template
{
...
";
  ...
  ";
          ...
          <div class=\"row\">
            ...
            yield "</p>
                  ";
            // line 107
            yield from $this->load("@MauticCore/Helper/button.html.twig", 107)->unwrap()->yield(CoreExtension::merge($context, ["buttons" => [["label" => "mautic.dashboard.apply_default", "variant" => "success", "href" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("mautic_dashboard_action", ["objectAction" => "applyDashboardFile", "file" => "default.json"])]]]));
            // line 116
            yield "              </div>
          </div>
      </div>
  ";
    ...
    {
        return new Source("", "@MauticDashboard/Dashboard/index.html.twig", "/var/www/html/docroot/app/bundles/DashboardBundle/Resources/views/Dashboard/index.html.twig");
    }
}
