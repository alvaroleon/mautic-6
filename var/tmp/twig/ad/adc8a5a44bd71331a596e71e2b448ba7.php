...
class __TwigTemplate_681163ef9ed0c4f19e46cc8d50ce2235 extends Template
{
    ...
    ";
            // line 4
            yield "    ";
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["item"]) || array_key_exists("item", $context) ? $context["item"] : (function () { throw new RuntimeError('Variable "item" does not exist.', 4, $this->source); })()), "isRoot", [], "method", false, false, false, 4)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 5
    ...
    ";
        ...
        ";
                // line 17
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["child"], "isDisplayed", [], "method", false, false, false, 17)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 18
                    yield "
            ";
                    // line 19
            ...
            ";
                ...
                ";
                    // line 37
                    if ((($tmp = (isset($context["showChildren"]) || array_key_exists("showChildren", $context) ? $context["showChildren"] : (function () { throw new RuntimeError('Variable "showChildren" does not exist.', 37, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 38
                        yield "                    ";
                        // line 39
                ...
                ";
                    // line 68
                    yield "                ";
                    if ((($tmp = (isset($context["showChildren"]) || array_key_exists("showChildren", $context) ? $context["showChildren"] : (function () { throw new RuntimeError('Variable "showChildren" does not exist.', 68, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 69
                        yield "                    ";
...
(isset($context["optionsMatchingDepth"]) || array_key_exists("optionsMatchingDepth", $context) ? $context["optionsMatchingDepth"] : (function () { throw new RuntimeError('Variable "optionsMatchingDepth" does not exist.', 73, $this->source); })())]);
                    ...
                    ";
                        // line 76
                        $context["levelClass"] = (((($tmp = (isset($context["isAncestor"]) || array_key_exists("isAncestor", $context) ? $context["isAncestor"] : (function () { throw new RuntimeError('Variable "isAncestor" does not exist.', 76, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("nav-submenu collapse in") : ("nav-submenu collapse"));
                        // line 77
                        yield "
                    ";
                        // line 79
...
";
    ...
    {
        return new Source("", "@MauticCore/Menu/main.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Menu/main.html.twig");
    }
}
