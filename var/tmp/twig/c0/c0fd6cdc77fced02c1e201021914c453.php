...
class __TwigTemplate_3133f3752b97e702761ef053cea7a1b7 extends Template
{
...
(isset($context["template"]) || array_key_exists("template", $context) ? $context["template"] : (function () { throw new RuntimeError('Variable "template" does not exist.', 11, $this->source); })()) === "delete")) {
        ...
        // line 38
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["confirmCallback"]) || array_key_exists("confirmCallback", $context) ? $context["confirmCallback"] : (function () { throw new RuntimeError('Variable "confirmCallback" does not exist.', 38, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 39
        ...
        // line 41
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["cancelText"]) || array_key_exists("cancelText", $context) ? $context["cancelText"] : (function () { throw new RuntimeError('Variable "cancelText" does not exist.', 41, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 42
        ...
        // line 44
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["confirmText"]) || array_key_exists("confirmText", $context) ? $context["confirmText"] : (function () { throw new RuntimeError('Variable "confirmText" does not exist.', 44, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 45
        ...
        // line 47
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["cancelCallback"]) || array_key_exists("cancelCallback", $context) ? $context["cancelCallback"] : (function () { throw new RuntimeError('Variable "cancelCallback" does not exist.', 47, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 48
        ...
        // line 57
        if ((($tmp =  !array_key_exists("wrapOpeningTag", $context)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 58
            yield "    ";
        ...
        if (array_key_exists("tooltip", $context)) {
            // line 64
            yield "    ";
            if ((($tmp =  !array_key_exists("tooltipPosition", $context)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 65
                yield "        ";
...
";
    ...
    {
        return new Source("", "@MauticCore/Helper/confirm.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Helper/confirm.html.twig");
    }
}
