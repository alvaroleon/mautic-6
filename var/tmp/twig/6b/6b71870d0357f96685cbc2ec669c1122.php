...
class __TwigTemplate_7bfce347dc2c38b72412dcb558d71440 extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->load("@MauticCore/Default/content.html.twig", 11);
...
(isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 27, $this->source); })()), "request", [], "any", false, false, false, 27), "get", ["object", "contacts"], "method", false, false, false, 27)]]]);
  ...
  ";
    ...
    {
        return new Source("", "@MauticLead/Import/new.html.twig", "/var/www/html/docroot/app/bundles/LeadBundle/Resources/views/Import/new.html.twig");
    }
}
