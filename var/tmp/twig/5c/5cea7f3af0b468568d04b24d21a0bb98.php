...
class __TwigTemplate_55223a54496a0fbfc853e7272ca6f415 extends Template
{
...
";
        // line 7
        if ((($tmp = (isset($context["is_icon_only"]) || array_key_exists("is_icon_only", $context) ? $context["is_icon_only"] : (function () { throw new RuntimeError('Variable "is_icon_only" does not exist.', 7, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 8
            yield "    ";
...
<span data-toggle=\"tooltip\" title=\"";
    ...
    <button type=\"button\"
        ...
        } elseif ((($tmp = (isset($context["is_icon_only"]) || array_key_exists("is_icon_only", $context) ? $context["is_icon_only"] : (function () { throw new RuntimeError('Variable "is_icon_only" does not exist.', 25, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
    ...
    >
        ";
        // line 27
        if ((($tmp =  !(isset($context["is_icon_only"]) || array_key_exists("is_icon_only", $context) ? $context["is_icon_only"] : (function () { throw new RuntimeError('Variable "is_icon_only" does not exist.', 27, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 28
            yield "            <i class=\"";
...
";
    ...
    {
        return new Source("", "@MauticCore/Helper/toggletip.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Helper/toggletip.html.twig");
    }
}
