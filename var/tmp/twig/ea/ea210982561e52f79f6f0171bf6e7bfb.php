...
class __TwigTemplate_03133b4a5ed4c352c0778adfa76f0c44 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        if (( !CoreExtension::getAttribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 6, $this->source); })()), "isXmlHttpRequest", [], "method", false, false, false, 6) &&  !(isset($context["modalView"]) || array_key_exists("modalView", $context) ? $context["modalView"] : (function () { throw new RuntimeError('Variable "modalView" does not exist.', 6, $this->source); })()))) {
            // line 7
            yield "    ";
            $context["template"] = (((($tmp = (isset($context["contentOnly"]) || array_key_exists("contentOnly", $context) ? $context["contentOnly"] : (function () { throw new RuntimeError('Variable "contentOnly" does not exist.', 7, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("@MauticCore/Default/slim.html.twig") : ("@MauticCore/Default/base.html.twig"));
        } elseif ((($tmp =  !        // line 8
(isset($context["modalView"]) || array_key_exists("modalView", $context) ? $context["modalView"] : (function () { throw new RuntimeError('Variable "modalView" does not exist.', 8, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 9
            yield "    ";
        ...
        yield "";
        // line 12
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["template"]) || array_key_exists("template", $context) ? $context["template"] : (function () { throw new RuntimeError('Variable "template" does not exist.', 12, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 13
...
";
    ...
    {
        return new Source("", "@MauticCore/Default/content.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Default/content.html.twig");
    }
}
