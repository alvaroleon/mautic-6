...
class __TwigTemplate_e3fb128350a2ce96a8569c0f461b6923 extends Template
{
...
\t\t\t\t";
        // line 16
        yield "\t\t\t\t";
        yield (((($tmp =  !is_iterable((isset($context["actions"]) || array_key_exists("actions", $context) ? $context["actions"] : (function () { throw new RuntimeError('Variable "actions" does not exist.', 16, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ((isset($context["actions"]) || array_key_exists("actions", $context) ? $context["actions"] : (function () { throw new RuntimeError('Variable "actions" does not exist.', 16, $this->source); })())) : (""));
        yield "
...
";
    ...
    {
        return new Source("", "@MauticCore/Default/pageheader.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Default/pageheader.html.twig");
    }
}
