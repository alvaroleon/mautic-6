...
class __TwigTemplate_dfdc3285b22a28372778337276fd0f53 extends Template
{
...
";
        ...
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["templateButtons"] ?? null), "delete", [], "any", true, true, false, 9) &&  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["templateButtons"]) || array_key_exists("templateButtons", $context) ? $context["templateButtons"] : (function () { throw new RuntimeError('Variable "templateButtons" does not exist.', 9, $this->source); })()), "delete", [], "any", false, false, false, 9)))) {
            // line 10
            yield "    ";
            yield $this->extensions['Mautic\CoreBundle\Twig\Extension\ButtonExtension']->addButton(["confirm" => ["message" => (((($tmp = $this->extensions['Mautic\CoreBundle\Twig\Extension\TranslatorExtension']->translatorHasId((            // line 12
(isset($context["translationBase"]) || array_key_exists("translationBase", $context) ? $context["translationBase"] : (function () { throw new RuntimeError('Variable "translationBase" does not exist.', 12, $this->source); })()) . ".form.confirmbatchdelete"))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans((            // line 13
...
";
        ...
        // line 34
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["dropdownButtons"]) || array_key_exists("dropdownButtons", $context) ? $context["dropdownButtons"] : (function () { throw new RuntimeError('Variable "dropdownButtons" does not exist.', 34, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 35
            yield "    <div class=\"dropdown ml-xs\">
        ";
            // line 36
            yield from $this->load("@MauticCore/Helper/button.html.twig", 36)->unwrap()->yield(CoreExtension::merge($context, ["buttons" => [["label" => "mautic.core.options", "size" => "lg", "variant" => "primary", "icon" => "ri-more-2-line", "icon_only" => true, "spin" => false, "attributes" => ["class" => "dropdown-toggle bdr-rds-0 pa-0", "data-toggle" => "dropdown", "type" => "button"]]]]));
            // line 53
            yield "        <ul class=\"pull-";
...
";
    ...
    {
        return new Source("", "@MauticCore/Helper/toolbar_bulk_actions.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Helper/toolbar_bulk_actions.html.twig");
    }
}
