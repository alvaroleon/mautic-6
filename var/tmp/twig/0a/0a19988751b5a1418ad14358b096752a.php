...
class __TwigTemplate_af5c54bbb4e2be41f620e13e2ddda0eb extends Template
{
...
(isset($context["currentList"]) || array_key_exists("currentList", $context) ? $context["currentList"] : (function () { throw new RuntimeError('Variable "currentList" does not exist.', 23, $this->source); })()), "id", [], "any", false, false, false, 23), "leadId" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["item"]) || array_key_exists("item", $context) ? $context["item"] : (function () { throw new RuntimeError('Variable "item" does not exist.', 23, $this->source); })()), "id", [], "any", false, false, false, 23)]), "data-toggle" => "ajax", "data-method" => "POST"], "btnText" => "mautic.lead.lead.remove.fromlist", "iconClass" => "ri-close-line"]]);
        ...
        ";
        // line 32
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["fields"]) || array_key_exists("fields", $context) ? $context["fields"] : (function () { throw new RuntimeError('Variable "fields" does not exist.', 32, $this->source); })()), "core", [], "array", false, false, false, 32), "email", [], "array", false, false, false, 32), "value", [], "array", false, false, false, 32))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 33
            yield "            ";
...
";
    ...
    {
        return new Source("", "@MauticLead/Lead/_list_row.html.twig", "/var/www/html/docroot/app/bundles/LeadBundle/Resources/views/Lead/_list_row.html.twig");
    }
}
