...
class __TwigTemplate_a99a3e67e131b0e7a25f9a7c62f42c96 extends Template
{
    ...
    public function block_elfinder_widget(array $context, array $blocks = []): iterable
    {
        ...
        yield " ";
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["value"]) || array_key_exists("value", $context) ? $context["value"] : (function () { throw new RuntimeError('Variable "value" does not exist.', 2, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield "value=\"";
    ...
    {
        return new Source("", "@FMElfinder/Form/elfinder_widget.html.twig", "/var/www/html/vendor/helios-ag/fm-elfinder-bundle/src/Resources/views/Form/elfinder_widget.html.twig");
    }
}
