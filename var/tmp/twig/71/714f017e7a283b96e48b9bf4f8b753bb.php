...
class __TwigTemplate_0889471af635bffe78e3c7fdd9b7d37f extends Template
{
...
";
        ...
        if (( !array_key_exists("fixedPages", $context) || Twig\Extension\CoreExtension::testEmpty((isset($context["fixedPages"]) || array_key_exists("fixedPages", $context) ? $context["fixedPages"] : (function () { throw new RuntimeError('Variable "fixedPages" does not exist.', 4, $this->source); })())))) {
            // line 5
            yield "    ";
            $context["limit"] = (((($tmp =  !array_key_exists("limit", $context)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (30) : ($this->env->getFilter('int')->getCallable()((isset($context["limit"]) || array_key_exists("limit", $context) ? $context["limit"] : (function () { throw new RuntimeError('Variable "limit" does not exist.', 5, $this->source); })()))));
            // line 6
            yield "    ";
            $context["totalPages"] = (((($tmp = (isset($context["limit"]) || array_key_exists("limit", $context) ? $context["limit"] : (function () { throw new RuntimeError('Variable "limit" does not exist.', 6, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (Twig\Extension\CoreExtension::round(((isset($context["totalItems"]) || array_key_exists("totalItems", $context) ? $context["totalItems"] : (function () { throw new RuntimeError('Variable "totalItems" does not exist.', 6, $this->source); })()) / (isset($context["limit"]) || array_key_exists("limit", $context) ? $context["limit"] : (function () { throw new RuntimeError('Variable "limit" does not exist.', 6, $this->source); })())), 0, "ceil")) : (1));
            // line 7
            yield "    ";
...
";
    ...
    {
        return new Source("", "@MauticCore/Helper/pagination.html.twig", "/var/www/html/docroot/app/bundles/CoreBundle/Resources/views/Helper/pagination.html.twig");
    }
}
